  ...
  return (
    <>
      ...
      sm:flex-row sm:gap-y-0"
              >
                {/* Image */}
                <div className="relative shrink-0 h-56 w-full sm:h-[200px] sm:w-[200px] bg-gradient-to-t from-primary/30  via-primary/10 to-[#1b1b1b]/10 backdrop-blur-md rounded-md">
                  <Image
                    src={speaker.img}
                    fill
                    alt=""
